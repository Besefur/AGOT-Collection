...
NDiplomacy = {
	...
	CONCLAVE_VASSAL_LIMIT_KING_MULT = 30.0, 				-- Extra Vassal Limit from the ruler's rank
	CONCLAVE_VASSAL_LIMIT_EMPEROR_MULT = 40.0, 			-- Extra Vassal Limit from the ruler's rank
...
NCharacter = {
	...
	CHANGE_SUCC_LAW_YEARS = 5,						-- Rulers must have reigned this long before they can change succession laws
...
NEconomy = {
	...
	WONDER_STACKING_PENALTY = 0.0,					-- Additional cost for each consecutive wonder construction
	WONDER_STACKING_PENALTY_SAME_TYPE = 0.0,			-- Extra penalty for construction wonders of the same type
